...
namespace Org.Apache.REEF.DistributedR
{
    ...
    /// </summary>
    public sealed class DistributedRDriver : IObserver<IAllocatedEvaluator>, IObserver<IDriverStarted>
    {
        private static readonly Logger _Logger = Logger.GetLogger(typeof(DistributedRDriver));
        private readonly IEvaluatorRequestor _evaluatorRequestor;

        [Inject]
        private DistributedRDriver(IEvaluatorRequestor evaluatorRequestor)
        {
        ...
        {
            _Logger.Log(Level.Info, string.Format("DistributedRDriver started at {0}", driverStarted.StartTime));
